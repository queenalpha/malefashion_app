                                    ...
                                    <tr>
                                        <td class="product__cart__item">
                                            ...
                                            <div class="product__cart__item__text">
                                                ...
                                                <h5>
                                                    <?php echo setRupiah(($value['product_price'] * $kurs_dollar)); ?>
                                                </h5>
                                            </div>
                                        </td>
                                                ...
                                                <form method="POST" action="shopping-cart.php">
                                                    <div>
                                                        ...
                                                        <h6><input type="number" name="product_quantity"
                                                                value="<?php echo $value['product_quantity']; ?>"></h6>
                                                    </div>
                                                    <div>
                                        ...
                                        <td class="cart__price">
                                            <span>
                                                <?php echo setRupiah(($value['product_quantity'] * ($value['product_price'] * $kurs_dollar))); ?>
                                            </span>
                                        </td>
                                        <form method="POST" action="shopping-cart.php">
                                            <td>
