            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <nav class="header__menu mobile-menu">
                        <ul>
                            <li <?php if ($_SERVER['SCRIPT_NAME'] == "/index.php") { ?> class="active" <?php } ?>><a
                                    href="./index.php">Home</a></li>
                            <li <?php if ($_SERVER['SCRIPT_NAME'] == "/shop.php") { ?> class="active" <?php } ?>><a
                                    href="./shop.php">Shop</a></li>
                            <li <?php if ($_SERVER['SCRIPT_NAME'] == "/blog.php") { ?> class="active" <?php } ?>><a
                                    href="./blog.php">Blog</a></li>
                            <li <?php if ($_SERVER['SCRIPT_NAME'] == "/about.php") { ?> class="active" <?php } ?>><a
                                    href="./about.php">About Us</a></li>
                            <li <?php if ($_SERVER['SCRIPT_NAME'] == "/contact.php") { ?> class="active" <?php } ?>><a
